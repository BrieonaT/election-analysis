...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > countywinning_count) and (countyvote_percentage > countywinning_percentage):
            countywinning_count = countyvotes
    ...
    winning_county_summary = (
        ...
        f"Largest Vote Count: {countywinning_count:,}\n"
        f"Largest Vote Count Percentage: {countywinning_percentage:.1f}%\n"
        f"-------------------------\n")
